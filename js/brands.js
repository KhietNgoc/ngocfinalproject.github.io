        ...
        if (products.length > 0) {
          ...
          while (pg <= pages) {
            if (pg == res.products.current_page) {
              str +=
                `<li class="page-item active"><a class="page-link" href="brands.html?id=` +
                id +
                `&page=` +
                pg +
                `">` +
              ...
              str +=
                `<li class="page-item"><a class="page-link" href="brands.html?id=` +
                id +
                `&page=` +
                pg +
                `">` +
